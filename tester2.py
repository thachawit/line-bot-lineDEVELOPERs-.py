...
def handle_text_message(event):
    ...
    if text == 'profile':
        ...
        confirm_template = ConfirmTemplate(text='Photo of Miyuu or Osaka trip?', actions=[
        ...
        carousel_template = CarouselTemplate(columns=[
            CarouselColumn(
				thumbnail_image_url='https://s3-us-west-2.amazonaws.com/awsrobomakerhelloworld-154344673743-bundlesbucket-1n2aine7xqbt8/image/osaka1024.jpg',
				title='Osaka1',
				text='Cooool',
				actions=[
					PostbackAction(
            ...
            CarouselColumn(
				thumbnail_image_url='https://s3-us-west-2.amazonaws.com/awsrobomakerhelloworld-154344673743-bundlesbucket-1n2aine7xqbt8/image/osaka2-1024.jpg',
				title='Osaka2',
				text='Women power',
				actions=[
					PostbackAction(
            ...
            CarouselColumn(
				thumbnail_image_url='https://s3-us-west-2.amazonaws.com/awsrobomakerhelloworld-154344673743-bundlesbucket-1n2aine7xqbt8/image/osaka3-1024.jpg',
				title='Osaka3',
				text='Where is this?',
				actions=[
					PostbackAction(
            ...
            CarouselColumn(
				thumbnail_image_url='https://s3-us-west-2.amazonaws.com/awsrobomakerhelloworld-154344673743-bundlesbucket-1n2aine7xqbt8/image/osaka4-1024.jpg',
				title='Osaka4',
				text='Nice Castle',
				actions=[
					PostbackAction(
						label='Another GirlPow',
						text='Nice Castle',
						data='Nice Castle'
					)
				]	
            ...
            CarouselColumn(
				thumbnail_image_url='https://s3-us-west-2.amazonaws.com/awsrobomakerhelloworld-154344673743-bundlesbucket-1n2aine7xqbt8/image/osaka5-1024.jpg',
				title='Osaka5',
				text='Full face !!',
				actions=[
					PostbackAction(
		    ...
		    CarouselColumn(
				thumbnail_image_url='https://s3-us-west-2.amazonaws.com/awsrobomakerhelloworld-154344673743-bundlesbucket-1n2aine7xqbt8/image/osaka6-1024.jpg',
				title='Osaka6',
				text='Tired ??',
				actions=[
					PostbackAction(
...
#	This line is to echo message back 
